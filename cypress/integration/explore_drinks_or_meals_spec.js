...
describe.skip('Todos os elementos devem respeitar os atributos descritos no protótipo para a tela de explorar bebidas ou comidas', () => {
...
describe.skip('A tela deve ter três botões: um para explorar por ingrediente, um para explorar por local de origem e um para pegar uma receita aleatória', () => {
...
describe.skip('Ao clicar em "Por Ingredientes", a rota deve mudar para tela de explorar ingredientes', () => {
...
describe.skip('Ao clicar em "Por Local de Origem", a rota deve mudar para tela de explorar por local de origem', () => {
...
describe.skip('Ao clicar em "Me Surpreenda!", a rota deve mudar para a tela de detalhes de uma receita, que deve ser escolhida de forma aleatória', () => {
